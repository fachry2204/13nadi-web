...
const routes = [
    ...
    {
        path: "/nadiku/slider/tambah",
        name: "slider-create",
        component: Blank,
        meta: { requiresAuth: true },
    },
    {
        path: "/nadiku/slider/:id/edit",
        name: "slider-edit",
        component: Blank,
        meta: { requiresAuth: true },
    },
    {
        path: "/nadiku/:module(banner|tentang|rilisan|artis|berita|foto|video)/tambah",
        name: "content-create",
        component: Blank,
        meta: { requiresAuth: true },
    },
    {
        path: "/nadiku/:module(banner|tentang|rilisan|artis|berita|foto|video)/:id/edit",
        name: "content-edit",
        component: Blank,
        meta: { requiresAuth: true },
    },
